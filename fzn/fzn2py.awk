...
END {
	...
	print "    solvers = ['Toulbar2'] #['Mistral', 'SCIP', 'MiniSat', 'Toulbar2', 'Gurobi']";
	print "    default = dict([('solver', 'Toulbar2'), ('verbose', 0), ('tcutoff', 900), ('var', 'DomainOverWDegree'), ('val', 'Lex'), ('rand', 2), ('threads', 1), ('restart', GEOMETRIC), ('base', 256), ('factor', 1.3), ('lcLevel', 4), ('lds', 0), ('dee',0), ('btd',0), ('rds',0), ('varElimOrder', 0), ('dichotomic', 0), ('dichtcutoff', 5), ('encoding', '')])";
